...
function validate() {
    ...
    if ($('#drpUserRole').val().length === 0) {
        $('#drpUserRole').css('border-color', 'Red');
        isValid = false;
    }
    else {
        $('#drpUserRole').css('border-color', 'lightgrey');
    }
...
function validateCUser() {
    ...
    if ($('#drpCompanyRole').val().length === 0) {
        $('#drpCompanyRole').css('border-color', 'Red');
        isValid = false;
    }
    else {
        $('#drpCompanyRole').css('border-color', 'lightgrey');
    }
                    ...
                    console.log('Sing_'+row.UserId);
                      if (row.IsApprover == '1') {
                          if (data == '1') {
                              ...
                              return '<label class="switch"><input id="allowSign_' + row.UserId + '" type="checkbox" onchange="UpdateAllowSign(this,' + row.UserId + ',\'' + row.UserName +'\')" ><span class="slider round" ></span></label>';   /*Toggle Switch off*/
                              ...
                              return '<label class="switch"><input id="allowSign_' + row.UserId + '" type="checkbox" checked onchange="UpdateAllowSign(this,' + row.UserId + ',\'' + row.UserName +'\')"><span class="slider round" ></span></label>';   /*Toggle Switch on*/
